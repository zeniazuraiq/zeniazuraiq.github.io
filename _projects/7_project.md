---
layout: page
title: improving pulsar timing array sensitivity using vlbi astrometry
...
deviations from pulse arrival times - and these are signs of exciting astrophysics!

There are many Pulsar Timing Array consortia around the world, including the Indian Pulsar Timing Array Experiment
(InPTA), of which I have been a member since 2023. These experiments montior radio pulsars, and search for signals pointing to a low frequency nanoHz Gravitational Wave background. In June 2023, InPTA combined its data with the EPTA dataset and detected strong HD correlation, which provides strong evidence of stochastic GW Background. Other PTA experiments reported the same. 
